...
<title>家庭成员运动数据新增</title>
  ...
  <script type="text/javascript" src="../js/sportadd.js"></script>
...
<body>
	<form class="layui-form layui-form-pane" id="addform" action="">
    	...
    	<div class="layui-form-item">
    		<label class="layui-form-label">运动方式</label>
    		<div class="layui-input-inline">
      			<input type="text" id="sport" name="sport" lay-verify="required" placeholder="请输入" autocomplete="off" class="layui-input">
    		</div>
    	</div>
    	<div class="layui-form-item">
